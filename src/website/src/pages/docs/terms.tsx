...
//   const layout = useLayoutContext();
//   return (
//     <div className="min-h-[60vh] flex flex-col items-center px-4 py-12">
//       {/* Optional banner & tagline */}
//       {layout?.showBanner && (
//         <div className="mb-6 text-center text-sm text-accent font-semibold">
//           {layout.showBanner}
//         </div>
//       )}
//       {layout?.showTagline && (
//         <div className="mb-10 text-center text-xs text-gray-400">
//           {layout.showTagline}
//         </div>
//       )}
...
//         <h1>Bitcoin Browser Miner – Terms of Service</h1>
//         <p className="text-sm italic">Last updated: May 4, 2025</p>

//         {/* 1. Overview */}
//         <h2>1. Overview of the Service</h2>
//         <p>
//           Bitcoin Browser Miner lets registered users log in and run JavaScript/
//           WebAssembly (WASM) code in their web browsers to attempt to mine
//           Bitcoin by hashing candidate block templates supplied by our backend
//           (see{' '}
//           <Link
//             href="https://github.com/KennyH/mine-bitcoin-online/blob/main/docs/adr/ADR-001-candidate-block-publishing-and-notification.md"
//             target="_blank"
//             rel="noopener noreferrer"
//           >
//             ADR‑001
//           </Link>
//           ). <strong>The Service is provided primarily for educational and
//           demonstrative purposes.</strong>
//         </p>
//         <p>
//           The complete source code for both the frontend miner and backend
//           infrastructure is published under the{' '}
...
//             rel="noopener noreferrer"
//           >
//             github.com/KennyH/mine-bitcoin-online
//           </a>
//           . While that license grants you broad rights to inspect, copy, modify,
//           and redistribute the code, use of the <em>live hosted Service</em>
//           remains subject to the additional terms and risk disclosures below.
//         </p>
...
//           contracts to create an account. When you register you must provide
//           accurate information and keep it up to date. You are responsible for
//           maintaining the confidentiality of your login credentials and for all
//           activities that occur under your account.
//         </p>

//         {/* 3. Odds */}
//         <h2>3. Astronomical Odds of Success</h2>
//         <p>
//           Mining Bitcoin with a typical consumer browser is{' '}
//           <strong>extraordinarily unlikely</strong> to solve a valid main‑net
//           block. <strong>Statistically, the odds approach zero.</strong>{' '}
//           <strong>You should expect to earn nothing.</strong> Any hash‑rate,
//           profit, or reward figures displayed by the Service are theoretical
//           estimates only and are <strong>not a guarantee of income</strong>.
//         </p>

//         {/* 4. Educational */}
//         <h2>4. Educational Use; No Professional Advice</h2>
//         <p>
//           The Service, documentation, blog posts, ADRs, code samples, and all
//           related content are offered solely for general information and
//           educational purposes. <strong>Nothing in the Service constitutes
//           financial, legal, tax, or investment advice.</strong> You should
//           consult qualified professionals before making decisions based on any
//           information obtained through the Service.
//         </p>

//         {/* 5. Risks */}
//         <h2>5. User Risks and Waiver of Liability</h2>
//         <p>
//           Running miner code may increase CPU usage, battery drain, power
//           consumption, device temperature, and fan noise, and could shorten
//           hardware life. Although we test our software,{' '}
//           <strong>
//             we do not guarantee it is free of defects or security
//             vulnerabilities.
//           </strong>{' '}
//           By using the Service you knowingly and voluntarily:
//         </p>
//         <ul>
//           <li>accept all risks associated with running the miner;</li>
//           <li>
//             agree that the Service is provided “AS IS” and “AS AVAILABLE”{' '}
//             <strong>without any warranty of any kind</strong>;
//           </li>
//           <li>
//             <strong>waive and release</strong> Bitcoin Browser Miner and its
//             owners, developers, employees, and agents (collectively,
//             “Provider”) from all claims, losses, and damages arising out of or
//             related to your use of the Service.
//           </li>
//         </ul>

//         {/* 6. Rewards */}
//         <h2>6. Block Reward Distribution &amp; Fees</h2>
//         <p>
//           If a main‑net block is successfully mined through the Service (see{' '}
//           <Link
//             href="https://github.com/KennyH/mine-bitcoin-online/blob/main/docs/adr/ADR-002-block-reward-distribution-and-user-payout.md"
//             target="_blank"
//             rel="noopener noreferrer"
//           >
//             ADR‑002
...
//           The code is open source under Apache 2.0 (see{' '}
//           <Link
//             href="https://github.com/KennyH/mine-bitcoin-online/blob/main/docs/adr/ADR-003-browser-miner-implementation-initial-phase.md"
//             target="_blank"
//             rel="noopener noreferrer"
//           >
//             ADR‑003
//           </Link>
//           ). When connecting to the hosted Service you <strong>must not</strong>:
//         </p>
//         <ul>
//           <li>redirect rewards, falsify shares, or otherwise compromise fairness;</li>
//           <li>use the Service to violate law or third‑party rights;</li>
...
//           <li>interfere with security, integrity, or performance.</li>
//         </ul>
//         <p>Provider may suspend or terminate accounts for violations.</p>

//         {/* 8. IP */}
//         <h2>8. Intellectual‑Property and Licensing</h2>
//         <p>
//           Source code is licensed under Apache 2.0. Branding and non‑code
//           content remain Provider’s property; you may not use them without
//           permission.
//         </p>
...
//             Privacy Policy
//           </Link>
//           , which explains what personal data we collect, how we use it, and
//           your rights and choices. By using the Service you consent to those
//           data practices.
//         </p>
...
//         <p>
//           <strong>
//             THE SERVICE IS PROVIDED “AS IS” AND “AS AVAILABLE.” PROVIDER
//             EXPRESSLY DISCLAIMS ALL WARRANTIES, WHETHER EXPRESS, IMPLIED,
//             STATUTORY, OR OTHERWISE, INCLUDING WARRANTIES OF MERCHANTABILITY,
//             FITNESS FOR A PARTICULAR PURPOSE, TITLE, AND NON‑INFRINGEMENT.
//           </strong>{' '}
//           Provider does not warrant that the Service will be uninterrupted,
...
//         <p>
//           TO THE MAXIMUM EXTENT PERMITTED BY LAW, PROVIDER’S TOTAL LIABILITY FOR
//           ANY CLAIM ARISING OUT OF OR RELATED TO THESE TERMS OR THE SERVICE WILL
//           NOT EXCEED <strong>US $100</strong>. IN NO EVENT WILL PROVIDER BE
...
//         <p>
//           You agree to defend, indemnify, and hold harmless Provider from and
...
//         {/* 13. Modifications */}
//         <h2>13. Modification of the Terms</h2>
//         <p>
//           Provider may update these Terms at any time by posting a revised
//           version on the website or within the Service. Material changes take
//           effect <strong>30 days</strong> after posting. Your continued use of
...
//         </p>
        ...
        // <p>
        //   You may stop using the Service at any time. Provider may suspend or
        //   terminate the Service or your account, or remove or disable content,
        //   if we reasonably believe you violate these Terms or applicable law, or
        //   if your use poses a security risk or legal liability.
        // </p>
        ...
        //   resolved informally will be settled <strong>exclusively by binding
        //   arbitration</strong> in Seattle, Washington, under the Commercial
        //   Arbitration Rules of the American Arbitration Association. YOU AND
        //   PROVIDER WAIVE THE RIGHT TO A JURY TRIAL AND TO PARTICIPATE IN CLASS
        //   ACTIONS.
        // </p>
        ...
        //   remaining provisions remain in full force. These Terms (together with
        //   the Privacy Policy) constitute the entire agreement between you and
        //   Provider regarding the Service and supersede all prior agreements or
        //   understandings.
        // </p>
...
//         <p>
//           Questions about these Terms? Email{' '}
//           <a href="mailto:legal@bitcoinbrowserminer.com" className="underline">
//             legal@bitcoinbrowserminer.com
//           </a>
//           .
//         </p>
...
//         <hr />
//         <p className="text-center font-semibold">
//           By clicking “I Agree” or creating an account, you acknowledge that you
