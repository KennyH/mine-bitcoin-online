...
//   // 1. Start custom auth (sign up should be handled separately if needed)
//   const startAuth = async (email: string) => {
//     setLoading(true);
//     setError(null);
//     try {
...
//         setStep("success");
//         setError(null);
//         // You can store tokens here if needed: result.AuthenticationResult.IdToken, etc.
//         return true;
//       } else if (result.ChallengeName === "CUSTOM_CHALLENGE") {
